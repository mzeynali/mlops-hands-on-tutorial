...
Refer to the [Blog Post here](https://medium.com/@mzeynali01/week-6-exploring-github-actions-automating-workflows-and-building-docker-containers-8fcf03dff1a2)
...
Refer to the [Blog Post here](https://medium.com/@mzeynali01/week-8-configure-aws-lambda-with-a-docker-image-and-invoke-via-api-575253634b27)
...
Refer to the [Blog Post here](https://medium.com/@mzeynali01/a-comprehensive-guide-to-configuring-kibana-with-an-elasticsearch-cluster-integrating-aws-115de2c39883)
...
- `Integrating AWS CloudWatch Logs with Elasticsearch`
...
- `Visualizing CloudWatch Logs in Kibana`
